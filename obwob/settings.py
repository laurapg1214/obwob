"""
Django settings for obwob project.
...
SECRET_KEY = "django-insecure-6_%*80_f&2tv$2kk&hs6dzjxd6!wn5r%&)zr=5i9wtgkq$lcj-"
...
WSGI_APPLICATION = "obwob.wsgi.application"
...
DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.mysql", # using MariaDB
        "NAME": config("DB_NAME"),
        "USER": config("DB_USER"),
